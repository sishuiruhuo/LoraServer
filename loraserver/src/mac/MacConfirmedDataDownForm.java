...
public class MacConfirmedDataDownForm extends MacPktForm{
		...
		try {
			...
			for(Field field : fields){
				...
				if(field.get(this)!=null&&!"".equals(field.get(this).toString())){
		            if((field.get(this)) instanceof MacConfirmedDataDownForm.Fctrl){
		            	System.arraycopy(((MacConfirmedDataDownForm.Fctrl)field.get(this)).ConvertToByte(),
		            			0, output, i, 
		            			((MacConfirmedDataDownForm.Fctrl)field.get(this)).getLength());
