...
public class MacJoinAcceptForm extends MacPktForm {
		...
		try {
			...
			for(Field field : fields){
				...
				if(field.get(this)!=null&&!"".equals(field.get(this).toString())){
		            if((field.get(this)) instanceof MacJoinAcceptForm.Dlsetting){
		            	System.arraycopy(((MacJoinAcceptForm.Dlsetting)field.get(this)).ConvertToByte(),
		            			0, output, i, 
		            			((MacJoinAcceptForm.Dlsetting)field.get(this)).getLength());
